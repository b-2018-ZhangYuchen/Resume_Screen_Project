...
def load_job_market_data():
    ...
    try:
        postings_by_sector = pd.read_csv("postings_by_sector.csv")
        postings_total_us = pd.read_csv("postings_total_us.csv")
        salary_overview = pd.read_csv("salary_overview_soc.csv")
